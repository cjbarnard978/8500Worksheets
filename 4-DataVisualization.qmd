...
(@) Plot 1 explanation: 
>I wanted to see how monthly and yearly admissions changed over time.
...
(@) Plot 2 explanation: 
>I wanted to see where and when queer people congregated in Utah, which is a very religious state. 
