...
for (statepopulations$STATE) {
  if (statepopulations$X1800 > 200000)
    next
  
  if (statepopulations$X1800 < 250000)
    next

  if (statepopulations$X1800 == NA)
    break 

  print (statepopulations$STATE)
}
```
...
for (gayguides$city) {
  ...
  if (gayguides$city == "Greenville")
    next 

  if (gayguides$city != "Greenville")
    break 

  print(gayguides$city)
}
```
