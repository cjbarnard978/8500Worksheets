...
ggplot(data = nhgisdata, aes(fill = percentagetmp)) + geom_sf(aes(fill = percentagetmp)) + scale_fill_continuous(type = "gradient") + scale_fill_distiller(name = "percentage of foreign born males", palette = "Spectral", breaks = pretty_breaks(n = 10))
```
...
#The Americas develop most of their national parks before 1960, but Europe and Oceania develop most of theirs after 1960. 
...
#before 1975, Britain had the most national parks at 10, France had 4, and Germany had 2, both on borders.
